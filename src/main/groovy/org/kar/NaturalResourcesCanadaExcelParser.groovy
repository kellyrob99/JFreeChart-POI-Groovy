...
class NaturalResourcesCanadaExcelParser
{
    ...
    public static final Map UNSPECIFIED = [sheet: SHEET1, offset: 172, max: 21, species: 'Unspecified']
    ...
    public static final List<Map> PROVINCIAL = [PINE, SPRUCE, FIR, DOUGLAS_FIR, MISCELLANEOUS_SOFTWOODS, MISCELLANEOUS_HARDWOODS, TOTAL_PLANTING]
    public static final List<Map> PRIVATE_LAND = offset([PINE, SPRUCE, FIR, DOUGLAS_FIR, MISCELLANEOUS_SOFTWOODS, MISCELLANEOUS_HARDWOODS, TOTAL_PLANTING], 220)
    public static final List<Map> FEDERAL = offset([PINE, SPRUCE, FIR, DOUGLAS_FIR, MISCELLANEOUS_SOFTWOODS, MISCELLANEOUS_HARDWOODS, TOTAL_PLANTING], 441)
    public static final List<Map> TOTAL = offset([PINE, SPRUCE, FIR, DOUGLAS_FIR, MISCELLANEOUS_SOFTWOODS, MISCELLANEOUS_HARDWOODS, TOTAL_PLANTING], 662)
